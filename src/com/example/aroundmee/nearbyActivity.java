...
public class nearbyActivity extends SherlockActivity implements ActionBar.OnNavigationListener,
		OnItemClickListener {
	...
	@Override protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<CharSequence> list = new ArrayAdapter<CharSequence>(this, R.layout.sherlock_spinner_item,R.id.textView1,places);
	...
	@Override public boolean onNavigationItemSelected(int itemPosition, long itemId) {
		...
		new readFromGooglePlaceAPI()
				.execute("https://maps.googleapis.com/maps/api/place/nearbysearch/json?"
						+ "location=11.016844,76.955832&radius=100000&sensor=true&"
						+ "key=AIzaSyDxQ5WohRD7zqILGp7VvpHYLozJWghr2fQ&types="
						+ places[itemPosition]);
	...
	public class readFromGooglePlaceAPI extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String str) {
			...
			adapter = new CustomAdapter(nearbyActivity.this, R.layout.list_row, myArrayList);
	...
	@Override public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		Intent details = new Intent(nearbyActivity.this, Details.class);
